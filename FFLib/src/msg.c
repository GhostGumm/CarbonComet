...
cometd_msg_connect_new(const cometd* h){
  ...
  json_object_set_int_member(adviceObject, "timeout", 30000);
  json_object_set_int_member(adviceObject, "interval", 2000);
  ...
  json_object_set_string_member(obj, "connectionType",         "websocket");
